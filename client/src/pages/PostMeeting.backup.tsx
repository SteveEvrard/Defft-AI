                  ...
                  <div className="space-y-8">
                    ...
                    <div className="bg-gradient-to-r from-[#4ECDC4]/10 to-[#FF6B4A]/10 border border-[#4ECDC4] p-6 rounded">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h3 className="text-lg font-medium text-slate-900 mb-2">Analysis Accuracy: 85-90%</h3>
                          <p className="text-sm text-slate-600">
                            Based on industry data and typical commercial printing operations. For precise recommendations, schedule a discovery call to gather specific equipment details and current spend data.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 mb-6">
                        If {answers.customer} operates HP Latex 800W or similar wide-format printers, we can provide a complete consumables and maintenance program.
                      </p>
                    ...
                    {/* Offset Lithography Cross-Sell */}
                    <div>
                      <h3 className="text-lg font-medium text-slate-900 mb-4">Opportunity 2: Offset Lithography Consumables Program</h3>
                      <p className="text-slate-600 mb-6">
                        If {answers.customer} operates offset lithography presses, we can provide a complete consumables package including plates, inks, chemistry, and maintenance.
                      </p>
